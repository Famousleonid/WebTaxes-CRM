...
@section('content')
    ...
    <div class="container shadow firm-border mt-3">
        <div class="card">
            <div class="card-body pt-0">

                <form id="createForm" class="createForm" role="form" method="post" action="{{route('firm.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="active tab-pane" id="create_firms">
                            <div class="col-md-12">
                                ...
                                <div class="card-header row">
                                    ...
                                    <span class="text-info text-bold" style="font-size: 1.2rem">Create company&nbsp;&nbsp;</span>
                                    <span class="text-danger text-bold" style="font-size: 1.2rem">for user: &nbsp;&nbsp;</span>
                                    {{--                                        <span class="text-info text-bold" style="font-size: 1.2rem">{{$user->name}}</span>--}}

                                    <div class="col-sm-7 form-group">
                                        <select  required name="user_id" class="form-control @error('user_id') is-invalid @enderror">
                                ...
                                <div class="card-body row" id="create_div_inputs">
                                    ...
                                    <div class="form-group col-md-12 mb-2">
                                        <small for="main_business_activity">Main business activity</small>
                                    ...
                                    <div class=" col-12 border  mb-2 border-info rounded">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="director_phone" data-tel-input id="director_phone" maxlength="18" class="form-control @error('director_phone') is-invalid @enderror" placeholder="phone">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" col-12 border border-info rounded">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="contact_phone" data-tel-input id="contact_phone" maxlength="18" class="form-control @error('contact_phone') is-invalid @enderror" placeholder="phone">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="div_tariff" class="form-group col-md-12 row div_tariff">
                                        ...
                                        <div class="col-md-3"><a href="{{route('price')}}" class="nav-link" this.onclick=>Choose a tariff</a></div>
                                    ...
                                    <div class="form-group container">
                                        <div class="card-body col-md-11">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <a href="{{route('firm.index')}}" class="btn btn-info btn-block">Return</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        let MainTariff = JSON.parse(localStorage.getItem('MainUser'));
        if (MainTariff) {
